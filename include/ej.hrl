...
-type ej_spec_type() :: missing | exact | string_match | json_type | array_elt.

-type ej_json_type_name() :: number | null | boolean | string | array | object.
...
-record(ej_invalid, {
          ...
          key           :: binary(),
          found         :: json_term(),
          found_type    :: ej_json_type_name(),
          expected_type :: ej_json_type_name(),
